...
INSERT INTO games (game,info,picturefile) VALUES ('SpaceInvaders', 'The classical Shoot''em up game. Don''t let the invaders conquer the world! Control it with left and right arrow keys or with the mouse. Shoot: space-key or mouse left-click. Touch control also possible!','/SpaceInvaders.PNG');
INSERT INTO games (game,info,picturefile) VALUES ('RabbitTracker', 'It is played like the classic game Minesweeper. Find the fields, where the rabbits are hiding and surround them.','/RabbitTracker.PNG');
