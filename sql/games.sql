...
INSERT INTO games (game,info,picturefile) VALUES ('RabbitTracker', 'It is played like the Classic game Minesweeper. Find the fields, where the rabbits are hiding and catch them.','/RabbitTracker.PNG');
