...
INSERT INTO games (game,info,picturefile) VALUES ('Snake', 'Snake is a classic computer game in which a snake moving straight or at right angles through a playing field. The aim of the game is to pick up the randomly appearing fruits offered as food and to avoid obstacles, including the snake''s own body.','/Snake.png');