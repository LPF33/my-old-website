...
INSERT INTO games (game,info,picturefile) VALUES ('SpaceInvaders', 'The classical Shootem up game. Controlling with arrow keys or with the mouse, shoot: space-key or mouse left-click. Touch also possible!','/SpaceInvaders.png');
